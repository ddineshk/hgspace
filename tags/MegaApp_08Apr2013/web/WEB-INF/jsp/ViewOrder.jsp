...
<table style="background-color:#FFFF88;width: 60%; border: 0;">
  ...
  <tr bgcolor="#FFFF88"><td colspan="2" align="center">
      <table style="width: 100%;background-color: #6468e7;border: 0;">
        <tr bgcolor="#CCCCCC">
          <td><b>Item Name</b></td>
        ...
        <c:if test="${!empty viewOrder}">
          <c:forEach var="lineItem" items="${order.lineItems}" varStatus="i">
            <tr bgcolor="#FFFF88">
              <td><b><a href="<c:url value="/viewItem.do">
