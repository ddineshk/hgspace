...
public class UsersRegForm extends ActionForm {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -512681211094183094L;
	...
	public ActionErrors validate(ActionMapping mapping,
		...
		}else if (this.getUsers_Phone() == null ||this.getUsers_Phone().length()>11) {
			err.add("phoneerr", new ActionMessage("jsp.user.reg.phoneerr1"));
