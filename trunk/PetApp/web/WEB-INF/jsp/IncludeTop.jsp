...
<body bgcolor="white">
	...
	<div align="center" style="width: 100%;border: 1;">
		<ul>
			<li class="green">
				<p><a href="<c:url value="/viewCategory.do?categoryName=FISH"/>">FISH</a></p>
				<p class="subtext"><img border="0" src="../images/fish2.gif" /></p>
			</li>
			<li class="yellow">
				<p><a href="<c:url value="/viewCategory.do?categoryName=DOGS"/>">DOGS</a></p>
				<p class="subtext">Dogs</p>
			</li>
			<li class="red">
				<p><a href="<c:url value="/viewCategory.do?categoryName=REPTILES"/>">REPTILES</a></p>
				<p class="subtext">Reptiles</p>
			</li>
			<li class="blue">
				<p><a href="<c:url value="/viewCategory.do?categoryName=CATS"/>">CATS</a></p>
				<p class="subtext">Cats</p>
			</li>
			<li class="purple">
				<p><a href="<c:url value="/viewCategory.do?categoryName=BIRDS"/>">BIRDS</a></p>
