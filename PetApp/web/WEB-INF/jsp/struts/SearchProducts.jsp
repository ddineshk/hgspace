...
<table style="background-color: #6468e7;border: 0;">
	<tr>
		<td bgcolor="#FFFF88"><a href="<c:url value="/shop/index.do"/>"><b><font color="BLACK" size="2">&lt;&lt; Main Menu</font></b></a></td>
	</tr>
</table>
</div>
<div align="center">
	<table style="background-color: #6468e7;border: 0;">
		...
		<tr bgcolor="#FFFF88">
			<td><a href="<c:url value="/shop/viewProduct.do"><c:param name="productNumber" value="${product.productNumber}"/></c:url>">
					<c:out value="${product.productDesc}" escapeXml="false" />
				</a></td>
			<td><b><a href="<c:url value="/shop/viewProduct.do"><c:param name="productNumber" value="${product.productNumber}"/></c:url>">
