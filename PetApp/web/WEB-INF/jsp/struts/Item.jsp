...
<c:if test="${item.quantity > 0}">
	<div align="left">
		...
		<tr>
			<td bgcolor="#FFFF88">
				<a href="<c:url value="/shop/viewProduct.do"><c:param name="productNumber" value="${product.productNumber}"/></c:url>">
	...
	<div align="center">
		<table style="background-color: #6468e7; border: 0; width: 60%;">
			...
			<tr bgcolor="#FFFF88">
				<td><html:link paramId="workingItemName" paramName="item" paramProperty="itemName" page="/shop/addItemToCart.do" transaction="true">
