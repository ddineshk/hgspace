...
<table style="width: 100%;">
	<tr>
		...
		<td valign="top" align="center">
			...
			<form action="<c:url value="/shop/updateCartQuantities.do"/>" method="post">
				<div align="center">
					<table style="background-color: #6468e7;border :0;">
						...
						<tr bgcolor="#FFFF88">
							<td><b><a href="<c:url value="/shop/viewItem.do"><c:param name="itemName" value="${cartItem.item.itemName}"/></c:url>">
							...
							<td><a href="<c:url value="/shop/removeItemFromCart.do"><c:param name="workingItemName" value="${cartItem.item.itemName}"/></c:url>">
			...
			<center>
				<a href="<c:url value="/shop/checkout.do"/>"> <img border="0" src="../images/button_checkout.gif" /></a>
			</center>
			</c:if>
		</td>
