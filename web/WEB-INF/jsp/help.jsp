...
<TABLE style="width: 70%;border: 0;">
  <TBODY>
    <TR>
      <TD vAlign=top>
          ...
          <font color=gray size=-1>
            Implementation by <a href="mailto:dinesh13284@gmail.com">Dinesh Kumar D</a>
          </font>
        ...
        <H2><A id=SigningUp></A>Signing Up</H2>
        <p>
        ...
        <H2><A id=SigningIn></A>Signing In</H2>You sign in to the application by
        ...
        <H2><A id=Catalog ></A>Working with the Product Catalog</H2>This section
        describes how to browse and search the product catalog.
        <H4><A id=CatalogBrowsing></A>Browsing the Catalog</H4>The pet store
        ...
        <H4><A id=CatalogSearching></A>Searching the Catalog</H4>You search for
        products by typing the product name in search field in the middle of the
        banner.
        <H2><A id=ShoppingCart></A>Working with the Shopping Cart</H2>
        <H4><A id=ShoppingCartAdd></A>Adding and Removing Items</H4>You add an
        ...
        the banner.
        <H4><A id=ShoppingCartUpdate></A>Updating the Quantity of&nbsp; an
        ...
        back ordered.
        <H4><A id=Ordering></A>Ordering Items</H4>You order the items in the
        ...
        <H2><A id=OrderReview></A>Reviewing An Order</H2>The final screen
    ...
    <H2><A id=Issues></A>Known Issues</H2>TBA.</TD></TR>
    <TR>
